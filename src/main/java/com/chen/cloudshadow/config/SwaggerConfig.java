 ...
 * @author 32632
 * @date Created in 2025/2/10 16:59
 * @modified By  32632 in 2025/2/10 16:59
...
public class SwaggerConfig {
    ...
    private ApiInfo apiInfo() {
        ...
        Contact contact = new Contact(
                ...
                "3263298665@qq.com"); // 作者邮箱

        return new ApiInfoBuilder()
                .title("云影项目API") //  可以用来自定义API的主标题
                .description("云影项目SwaggerAPI管理") // 可以用来描述整体的API
